...
def label_matured_samples(
    ...
    *,
    ...
    The target is the last midpoint observation strictly after the forecast origin
    and at or before the requested horizon. The first observation after t+h is
    never borrowed. If the last admissible observation is too stale relative to
    t+h, the row remains unlabeled. This is the canonical V7 causal target
    contract for fixed-horizon Micro Taker research and PAPER execution.
    """
