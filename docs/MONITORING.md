...
Grafana is an operator view for the single PAPER crypto engine. Prometheus exports the crypto-only scope plus fail-closed SHA, single-writer, ledger, portfolio, feed and safety metrics.
