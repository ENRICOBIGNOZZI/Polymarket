...
All crypto component output is normalized to account-wealth candidate actions. Priority is global kill, strategy/market kill, critical cancel, liquidation, urgent inventory reduction, normal risk reduction, complete-set opportunity, informed take, passive make and nothing.
