...
def render_prometheus(snapshot: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        _metric("polymarket_v7_native_engine_running", (snapshot.get("native_engine") or {}).get("state") == "RUNNING"),
        _metric("polymarket_v7_native_engine_child_pid", (snapshot.get("native_engine") or {}).get("child_pid")),
        _metric("polymarket_v7_native_evidence_healthy", (snapshot.get("native_evidence") or {}).get("healthy")),
        _metric("polymarket_v7_native_evidence_published_total", (snapshot.get("native_evidence") or {}).get("published")),
        _metric("polymarket_v7_native_evidence_written_total", (snapshot.get("native_evidence") or {}).get("written")),
        _metric("polymarket_v7_native_evidence_dropped_total", (snapshot.get("native_evidence") or {}).get("dropped")),
        _metric("polymarket_v7_native_settled_market_count", (snapshot.get("native_settlement") or {}).get("settled_market_count")),
        _metric("polymarket_v7_native_realized_pnl_usd", (snapshot.get("native_settlement") or {}).get("realized_pnl")),
