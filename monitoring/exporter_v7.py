...
def render_prometheus(snapshot: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        _metric("polymarket_v7_universe_clob_complete", universe.get("clob_complete")), _metric("polymarket_v7_universe_clob_error_present", universe.get("clob_error_present")), _metric("polymarket_v7_universe_gamma_fallback_requests", universe.get("gamma_fallback_requests")), _metric("polymarket_v7_universe_gamma_fallback_errors", universe.get("gamma_fallback_errors")), _metric("polymarket_v7_universe_cache_fallback_markets", universe.get("cache_fallback_markets")), _metric("polymarket_v7_universe_missing_markets", universe.get("missing_markets")),
    ]
    lines.append(_metric("polymarket_v7_universe_source_mode_info", 1, {"mode": str(universe.get("source") or "UNKNOWN")}))
