...
def _append_external_fair_metrics(lines: list[str], report: dict[str, Any]) -> None:
    ...
    lines.extend([
        ...
        metric("polymarket_external_fair_counterfactual_forecasts_total", router.get("counterfactual_forecasts")),
        metric("polymarket_external_fair_counterfactual_resolved_forecasts_total", router.get("counterfactual_resolved_forecasts")),
        metric("polymarket_external_fair_counterfactual_pending_forecasts", router.get("counterfactual_pending_forecasts")),
