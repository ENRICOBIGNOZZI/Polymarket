...
bool NativePaperPairExecutionAdapter::release_delay(
    ...
    elapsed.source = OmsEventSource::Paper;
...
bool NativePaperPairExecutionAdapter::fill_leg(
    ...
    wire.source = OmsEventSource::Paper;
    ...
    ack.source = OmsEventSource::Paper;
    ...
    fill.source = OmsEventSource::Paper;
...
NativePaperPairResult NativePaperPairExecutionAdapter::submit(
    ...
    begin.source = OmsEventSource::Paper;
