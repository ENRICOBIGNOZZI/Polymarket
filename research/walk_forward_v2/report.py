...
def public_economics(economics):
    ...
    return {
        ...
        **SAFETY,
        ...
        "live_parity_partial_pool_horizon_latency": economics.get("live_parity_partial_pool_horizon_latency", {}),
        "required_net_markout_sensitivity": economics.get("required_net_markout_sensitivity", {}),
        "size_capacity_sensitivity": economics.get("size_capacity_sensitivity", {}),
        "common_support_economics": economics.get("common_support_economics", {}),
