...
# Always start with a syntactically valid feed. A failed telemetry refresh keeps
# the prior valid runtime feed rather than turning stale/raw features into q.
