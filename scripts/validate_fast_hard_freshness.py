...
def main() -> int:
    ...
    # Raw hard observations remain visible for diagnosis, but only freshness-qualified
    # observations are allowed to satisfy the promotion hard-count requirement.
    ...
    Path(args.output_json).write_text(json.dumps(guard, indent=2, sort_keys=True) + "\n", encoding="utf-8")
