...
PROMETHEUS_METRICS = (
    ...
    "polymarket_v7_live_algorithm_count",
    "polymarket_v7_legacy_algorithm_count",
...
def capability_map(repo: pathlib.Path) -> dict[str, Any]:
    ...
    return {
        ...
        "structural_relation_data_rows": max(0, len([line for line in relations if line.strip()]) - 1),
