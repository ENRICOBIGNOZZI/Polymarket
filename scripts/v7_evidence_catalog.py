...
def definitions():
    ...
    items=[
      ...
      family('profit_experiments',['profit_experiments/**/observations.jsonl*','profit_experiments/**/manifest.json','profit_experiments/**/sources/*.json.gz','profit_experiments/**/settlements.json'],
      ...
      family('coordinator_decisions',['coordinator/decisions.jsonl*','global_portfolio/decisions.jsonl*','control/decisions.jsonl*','opportunities/decisions.jsonl*'],
      ...
      family('maker_learning',['micro_maker/research_evidence.jsonl*','micro_maker/evidence.jsonl*','micro_maker/execution_model.json','micro_maker/book_features/*.json'],
