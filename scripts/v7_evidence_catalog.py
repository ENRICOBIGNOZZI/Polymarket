...
def definitions():
    ...
    items=[
      family('canonical_ledger',['ledger/execution.jsonl','archive/canonical-ledger/execution-*.jsonl.gz'],
        'v7_ledger_spool.py / V7_CANONICAL_LEDGER', ['portfolio','OMS','attribution','permanent datasets'],
      ...
      family('point_in_time_crypto_universe',['universe_snapshots/*.json.gz','universe/*.json','universe/*.jsonl*'],
        'crypto universe archiver / crypto universe',['market selection','historical crypto opportunity universe'],
        'polymarket_v7_point_in_time_crypto_universe_v1 and versioned crypto selection schemas',
