...
LIVE_MODEL_SURFACE_PATTERNS = (
    ...
    re.compile(r"^scripts/v\d+_(?:external_bridge|hard_arb_paper|intent_guard|local_factor_intents|materialize_configs|micro_taker|queue_filter|relation_intents)\.py$"),
)
