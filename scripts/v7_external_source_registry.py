...
EVENT_KINDS = {"BOOK_SNAPSHOT", "BOOK_DELTA", "BEST_BID_ASK", "TRADE", "MARK_PRICE", "INDEX_PRICE", "FUNDING", "OPEN_INTEREST", "LIQUIDATION", "OPTION_TICKER", "OPTION_SURFACE", "VOLATILITY_INDEX", "ORACLE_OBSERVATION", "PREDICTION_MARKET_BOOK", "PREDICTION_MARKET_TRADE", "MARKET_METADATA", "OFFICIAL_ANNOUNCEMENT", "CORRECTION", "HEARTBEAT", "SOURCE_STATUS"}
