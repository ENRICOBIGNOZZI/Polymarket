...
def build(ledger_path: Path, *, model_sha: str, strategy: str = "CRYPTO_SETTLEMENT_ENGINE", min_bundles: int = 20) -> dict[str, Any]:
...
def main() -> int:
    ...
    parser.add_argument("--strategy", default="CRYPTO_SETTLEMENT_ENGINE")
