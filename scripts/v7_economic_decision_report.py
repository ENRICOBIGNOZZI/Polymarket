...
def memo(report):
    ...
    return '\n'.join([
        ...
        '9. **Forward proof:** freeze a new eight-hour cohort before its first eligible contract; keep each contract in one temporal partition; evaluate the three predeclared primary endpoints and report every censor/exclusion.',
