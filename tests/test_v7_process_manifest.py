...
def test_manifest_matches_all_24_launcher_children_and_two_runtime_owners() -> None:
    report = resolve(ROOT, manifest())
    assert report["process_count"] == 26
    assert report["launcher_child_count"] == 24
...
if __name__ == "__main__":
    test_manifest_matches_all_24_launcher_children_and_two_runtime_owners()
