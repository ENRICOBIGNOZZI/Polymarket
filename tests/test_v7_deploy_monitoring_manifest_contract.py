...
class V7DeployMonitoringManifestContractTest(unittest.TestCase):
    def test_deploy_preflight_matches_canonical_monitoring_manifest_v3(self) -> None:
        ...
        self.assertIn("assert m.get('schema') == 'polymarket_v7_monitoring_manifest_v3'", workflow)
