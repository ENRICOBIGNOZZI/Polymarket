...
class V7ControlPlaneTest(unittest.TestCase):
    ...
    def test_deprecated_control_artifacts_must_remain_absent(self) -> None:
        self.assertEqual([path for path in control.DEPRECATED_CONTROL_ARTIFACTS if (ROOT / path).exists()], [])
