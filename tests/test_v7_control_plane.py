...
class V7ControlPlaneTest(unittest.TestCase):
    ...
    def test_live_manifest_binds_approval_envelope_hash(self) -> None:
        modes = control.load_json(ROOT / "config/v7_execution_modes.json")
        manifest = {"schema_version": 1, "exact_code_sha": "a" * 40, "build_manifest_hash": "b" * 64, "config_bundle_hash": "c" * 64, "strategy_registry_hash": "d" * 64, "model_registry_hash": "e" * 64, "policy_hash": "f" * 64, "dataset_manifest_hash": "1" * 64, "approval_envelope_hash": "4" * 64, "execution_mode": "MICRO_LIVE", "wallet_id_hash": "2" * 64, "signer_session_id_hash": "3" * 64, "server_id": "private-server", "region": "private-region", "run_id": "run", "start_time": "2026-08-31T00:00:00Z"}
    ...
    def test_control_manifest_schema_matches_the_validator(self) -> None:
        ...
        expected = {"schema_version", "exact_code_sha", "build_manifest_hash", "config_bundle_hash",
                    "strategy_registry_hash", "model_registry_hash", "policy_hash", "dataset_manifest_hash", "approval_envelope_hash",
                    "execution_mode", "wallet_id_hash", "signer_session_id_hash", "server_id", "region",
                    "run_id", "start_time"}
        self.assertEqual(set(schema["required"]), expected)
        self.assertEqual(set(schema["properties"]), expected)
        self.assertIn("approval_envelope_hash", schema["properties"])
