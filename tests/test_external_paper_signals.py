...
class ExternalPaperSignalTests(unittest.TestCase):
    ...
    def test_direct_probability_materializes_with_mapping_haircut(self) -> None:
    ...
    def test_low_mapping_confidence_stale_future_and_invalid_rows_fail_closed(self) -> None:
        rows = [
            self.row(market_id="mapping", mapping_score=0.69),
