...
def test_london_launcher_has_no_training_or_retrospective_analytics():
    ...
    forbidden=['v7_external_rich_train.py','v7_external_residual_train.py','v7_maker_durable_learning.py','v7_pm_repricing_shadow.py','v7_two_sided_complete_set_shadow.py','v7_generate_economic_artifacts.py','v7_profit_attribution.py','v7_profit_report.py','v7_economic_decision_report.py','v7_lossless_data_compaction.py','v7_permanent_evidence.py']
...
def test_runtime_and_research_process_manifests_are_disjoint():
    ...
    assert runtime['expected_process_count']==19 and runtime['expected_launcher_child_count']==16
