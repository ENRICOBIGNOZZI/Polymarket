...
import shutil, shlex, subprocess, tempfile
...
def test_poly1271_digest_and_wrapper_match_official_v2_fixture():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        subprocess.run([cxx,'-std=c++20','-O2','-Wall','-Wextra','-Wpedantic',f'-I{ROOT/"include"}',*inc,
            str(ROOT/'src/v7_clob_eip712.cpp'),str(ROOT/'src/v7_keccak_fast.cpp'),str(ROOT/'src/v7_poly1271.cpp'),str(src),'-o',str(binary),*libs],
