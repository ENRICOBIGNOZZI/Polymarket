...
class NativeReplayTests(unittest.TestCase):
 ...
 def test_paired_research_book_gap_and_flow_filter(self):
  ...
  for seq,offset,trade in [(1,-10,None),(2,100,{'aggressor_side':'SELL','price':.5,'size':10,'exchange_event_ns':1100000000}),(3,42010,None)]:
   book.ingest({'schema':SCHEMA,'model_sha':sha,'paper_only':True,'authenticated_execution':False,'real_order_submission':False,
       ...
       'exchange_event_ns':1000000000+offset*1000000,'valid':True,'lineage_continuous':True,'features_valid':True,
