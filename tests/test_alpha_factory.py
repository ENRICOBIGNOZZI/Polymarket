...
class AlphaFactoryTests(unittest.TestCase):
    ...
    def test_fdr_and_absolute_bootstrap_reasons_are_both_reported(self) -> None:
        ...
        self.assertIn("bootstrap_gate", candidate["reasons"])
    ...
    def test_atomic_outputs_are_machine_readable(self) -> None:
